...
export default function BackgroundRemover() {
        ...
        <div className="max-w-xl mx-auto">
          <div
            ...
            className={`
              ...
              hover:border-primary-300 hover:bg-white/80
              backdrop-blur-xl
          ...
          >
            ...
            <div
              className={`
                w-12 h-12 mx-auto mb-6 rounded-xl
            ...
            <p className="text-gray-700 font-medium text-sm mb-1.5 tracking-[-0.01em]">
              ...
              <span className="text-primary-600 hover:text-primary-700 underline underline-offset-[3px] decoration-primary-300/60">
                browse files
              </span>
            </p>
          ...
          {errorMsg && (
            <div className="mt-4 py-3 px-4 rounded-xl bg-red-50/80 border border-red-200/60 text-red-600 text-[13px] text-center backdrop-blur-sm">
              {errorMsg}
            </div>
          )}
        </div>
  ...
  /* ================================================================
     UPLOADED / DONE — Before & after cards
     ================================================================ */
  return (
    <section className="px-6 pb-20 fade-up">
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="rounded-2xl bg-white/70 backdrop-blur-xl border border-black/[0.04] shadow-[0_1px_3px_rgba(0,0,0,0.04),0_8px_40px_rgba(0,0,0,0.04)] overflow-hidden">
            <div className="px-5 py-3 border-b border-black/[0.04] flex items-center justify-between">
              ...
              <span className="text-[11px] text-gray-300 truncate max-w-[140px] font-mono">
                {fileName}
              </span>
            </div>
            ...
            <div className="px-5 py-3 border-b border-black/[0.04] flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${
                  status === "done" ? "bg-emerald-400" : "bg-gray-300"
                }`}
              />
              <span className="text-xs font-medium text-gray-500 uppercase tracking-wider">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
          {status === "uploaded" && (
            <button
              ...
              className="
                ...
                bg-gray-900 text-white text-sm font-medium tracking-[-0.01em]
                shadow-[0_1px_2px_rgba(0,0,0,0.1),0_4px_16px_rgba(0,0,0,0.1)]
                hover:shadow-[0_2px_8px_rgba(0,0,0,0.15),0_8px_32px_rgba(0,0,0,0.12)]
          ...
          <button
            ...
            className="
              ...
              text-gray-600 text-sm font-medium tracking-[-0.01em]
        ...
        {errorMsg && (
          <div className="mt-6 py-3 px-4 rounded-xl bg-red-50/80 border border-red-200/60 text-red-600 text-[13px] text-center max-w-md mx-auto backdrop-blur-sm">
            {errorMsg}
          </div>
        )}
      </div>
